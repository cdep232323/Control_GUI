/*
	g++ -o testInt testmqtt.cpp -I /usr/include/tasutils/io -I /usr/include/tasutils/messaging -lTASmessaging -lTASjson -lmosquitto -lpthread -lprotobuf
*/
...
int main(int argc, char** argv) {
	...
	if(argc == 3) {
		printf("value int: %d\n", state);
		client.publishBool(Topic, (bool)state);
	}
